...
camion1.getInfo()
print(f"Marca: {camion1.getMarca()} {camion1.getColor()}, numeros de plazas: {camion1.getPlazas()} \nModelo: {camion1.getModelo()} con una velocidad de {camion1.getVelocidad()} Km/h y un potencia de {camion1.getCaballaje()} hp, con {camion1.getEje()} con una capacidad de carga de {camion1.getCapacidadCarga()} metros cubicos")
